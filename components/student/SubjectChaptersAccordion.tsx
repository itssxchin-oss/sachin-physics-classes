...
import { Play, CheckCircle2, Video, Clock, BookOpen, ArrowRight } from "lucide-react";
              ...
              {chapterSubjectId && (
                <div className="flex items-center gap-3 flex-shrink-0 w-full sm:w-auto justify-end border-t sm:border-t-0 pt-3 sm:pt-0 border-white/5">
                  <Link
                    ...
                    className="px-4 py-2 rounded-xl bg-blue-600/20 hover:bg-blue-600 text-blue-300 hover:text-white border border-blue-500/30 font-bold text-xs flex items-center gap-1.5 transition-all shadow-sm"
                  >
