    ...
    <div className="min-h-screen hero-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20 fade-up">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 mt-1 text-sm">Join Sachin Physics Classes today</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-white/10 text-slate-400 font-semibold rounded-xl flex items-center justify-center gap-3 border border-white/20 hover:bg-white/20 transition-colors mb-6"
        >
